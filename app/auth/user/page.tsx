...
export default function LoginUser() {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!userType) return;
        router.push(`/auth/login?user=${userType}`)
    };
    ...
    return (
        <>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <label className="flex items-center gap-2 cursor-pointer">
                            ...
                            />
                            <span className="text-[#0C287B] font-medium">Provider</span>
                        </label>
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input
                                type="radio"
                                ...
                                className="accent-[#0C287B] w-5 h-5 border-2 border-[#0C287B] focus:ring-[#0C287B]"
                            />
                            <span className="text-[#0C287B] font-medium">Worker</span>
                        </label>
                    </div>
                </div>
            ...
            <p className="text-center text-[#0C287B] pt-2">
                Don't have an account? <Link href="/auth/account" className="text-red-500 underline">Create one</Link>
            </p>
        </>
    );
}