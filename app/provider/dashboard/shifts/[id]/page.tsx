...
export default function ShiftDetailsPage() {
    const { id } = useParams();
    const { shift, fetchShift } = useStore(useShallow((state) => ({
        shift: state.shift,
        ...
        <div className="mb-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4 mb-4">
                    ...
                    <h1 className="text-3xl text-gray-800 font-bold">{getAccountTypeDisplay(shift.title)}</h1>
            ...
            <Tabs defaultValue="details" className="w-full mt-6">
                ...
                <TabsContent value="applications">
                    <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6 min-h-[200px] flex items-center justify-center text-muted-foreground">
                        {/* TODO: Render shift applications here */}
