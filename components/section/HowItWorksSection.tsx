...
export default function HowItWorksSection() {
    return (
        <section className="w-full py-16 bg-secondary text-white mb-8">
            <h2 className="text-3xl font-bold text-center mb-8">How It Works</h2>
            <div className="flex flex-col md:flex-row justify-center items-center gap-8 max-w-5xl mx-auto">
                {steps.map((step, idx) => (
                    <div key={step.title} className="flex flex-col items-center text-center max-w-xs">
                        <div className="w-12 h-12 mb-3 flex items-center justify-center rounded-full bg-white text-secondary font-bold text-xl">{idx + 1}</div>
